...
import('/assets/js/scrollbar/simplebar.js');
import('/assets/js/scrollbar/custom.js');
import('/assets/js/config.js');
import('/assets/js/sidebar-menu.js');
import('/assets/js/script.js');


import('/assets/vendors/icons/feather-icon/feather.min.js');
import('/assets/vendors/icons/feather-icon/feather-icon.js');
            ...
            <div class="header-wrapper row m-0">
                <div class="header-logo-wrapper col-auto p-0">
                    ...
                    <div class="logo-header-main">
                        <a href="/">
                            <img class="img-fluid for-light img-100" src="../assets/images/logo/logo2.png" alt="">
                ...
                <div class="left-header col horizontal-wrapper ps-0">
                    ...
                    <!-- List -->
                        ...
                        <ul class="header-left" id="menu-bar">
                        
                        <!-- Menu Atas --
                            <li class="onhover-dropdown">
                                <span class="f-w-600">Dashboard</span>
                ...
                <div class="nav-right col-6 pull-right right-header p-0">
                    <ul class="nav-menus">
                        <li style="display: none;">
                            <div class="mode" style="display: none;"><i class="fa fa-moon-o"></i></div>
                        </li>
                        <li class="onhover-dropdown">
                                ...
                                <li>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <p>
                                                <a href="">New Update</a>
                                                <span class="pull-right">5/22/23</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
