...
const db = firebase.firestore().collection("/koraa/items/design/ux design/application/");
...
myForm.addEventListener('submit', function(e) {
  ...
  .then(function() {
    ...
    .then(function(docRef) {
      console.log('Item added to "items" collection with ID: ', docRef.id);
    })
...
document.getElementById('fileButton').addEventListener('change', function(e) {
  ...
  var uploadTask = storageRef.child('/koraa/items/design/ux design/application/' + uid + '/' + fileName).put(file);
